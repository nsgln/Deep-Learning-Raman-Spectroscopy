...
%The main dataset provided is composed of spectra belonging to patients affected by Amyotrophic Lateral Sclerosis (ALS) and healthy ones (CTRL). All the spectra belonging to a same patient are correlated between each other. 

%We also use pre-trained models that are trained on an external bacteria dataset.
